    ...
    return (
        ...
        >
            <div className="relative aspect-[16/9] overflow-hidden border-b border-black/[.06] bg-stone-100 dark:border-white/[.06] dark:bg-[#0b0b0b]">
                {previewImage ? (
                    ...
                    <>
                        ...
                        <div className="relative grid size-full place-items-center">
                            <span className="grid size-14 place-items-center rounded-2xl border border-black/10 bg-white/70 text-stone-500 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/[.04] dark:text-stone-400">
                ...
                />
                <span className="absolute right-4 top-4 rounded-full border border-black/10 bg-white/75 px-2.5 py-1 text-[11px] font-medium text-stone-600 shadow-sm backdrop-blur dark:border-white/10 dark:bg-black/45 dark:text-stone-300">
                        ...
                        {editing ? (
                            ...
                            <>
                                <Button
                                    type="text"
                                    size="small"
                                    className="!size-8 !min-w-8 !rounded-xl !text-stone-500 hover:!bg-black/5 dark:hover:!bg-white/10"
                                ...
                                <Button
                                    type="text"
                                    size="small"
                                    className="!size-8 !min-w-8 !rounded-xl !text-stone-500 hover:!bg-red-500/10 hover:!text-red-500"
