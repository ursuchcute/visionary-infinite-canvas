---
title: Docker 部署
description: 使用 Docker Compose 部署 Visionary Infinite Canvas
---
...
services:
  app:
    image: ghcr.io/ursuchcute/visionary-infinite-canvas:latest
    ports:
      - "3000:3000"
    environment:
...
docker run -d -p 3000:3000 \
  ...
  ghcr.io/ursuchcute/visionary-infinite-canvas:latest
```
