...
Contributor License Agreement，见 [CLA.md](https://github.com/ursuchcute/visionary-infinite-canvas/blob/main/CLA.md)。
...
- 提交内容可以随本 Fork 以 AGPL-3.0 发布；CLA 仅覆盖提交者自己的贡献，不改变上游代码的权利归属。
