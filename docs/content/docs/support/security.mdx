...
安全策略英文原文见 [SECURITY.md](https://github.com/ursuchcute/visionary-infinite-canvas/blob/main/SECURITY.md)。

请不要在公开 Issue 中直接发布漏洞细节、可利用代码、私密 API Key、截图中的敏感信息或真实用户数据。

## 提交流程

优先使用本仓库的 [GitHub 私密漏洞报告](https://github.com/ursuchcute/visionary-infinite-canvas/security/advisories/new)。如果暂时无法使用私密渠道，可以先开一个公开 Issue 请求维护者提供私密联系方式，但不要在 Issue 中写入漏洞细节。
